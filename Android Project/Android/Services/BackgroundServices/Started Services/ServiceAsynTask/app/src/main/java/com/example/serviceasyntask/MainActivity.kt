package com.example.serviceasyntask
...
import com.example.serviceasyntask.Service.DownloadService
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        runBtn.setOnClickListener(View.OnClickListener {
            ...
            for(song in SongsPlaylist.songsList){
                val startIntentToDownloadService = Intent(this@MainActivity, DownloadService::class.java)
        ...
        cancleBtn.setOnClickListener {
            ...
            stopService(stopIntentToDownloadService)
        }
